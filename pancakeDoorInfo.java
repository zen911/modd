...
public class pancakeDoorInfo
{
    ...
    private int gateOpeningRestrictionCounter;

    public pancakeDoorInfo(int par1, int par2, int par3, int par4, int par5, int par6)
    {
        isDetachedFromVillageFlag = false;
        gateOpeningRestrictionCounter = 0;
        posX = par1;
        posY = par2;
        posZ = par3;
    ...
    {
        gateOpeningRestrictionCounter++;
    }

    public int getDoorOpeningRestrictionCounter()
    {
        return gateOpeningRestrictionCounter;
    }
}