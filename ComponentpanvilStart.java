...
public class ComponentpanvilStart extends Componentcenter
{
	...
	public StructurepanvilPieceWeight structpanvilPieceWeight;

    public ComponentpanvilStart(WorldChunkManager par1WorldChunkManager, int par2, Random par3Random, int par4, int par5, ArrayList par6ArrayList, int par7)
    {
