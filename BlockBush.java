...
public class BlockBush extends BlockLeavesBase
{
    ...
    protected BlockBush(int par1, int par2)
    {
    ...
    {
        return mod_item.blueberry.shiftedIndex;
    }
    ...
    public void dropBlockAsItemWithChance(World par1World, int par2, int par3, int par4, int par5, float par6, int par7)
    {
        if (!par1World.isRemote)
        {
            ...
            {
                dropBlockAsItem_do(par1World, par2, par3, par4, new ItemStack(mod_item.blueberry, 1, 0));
            }
        }
    }
    ...
    public void harvestBlock(World par1World, EntityPlayer par2EntityPlayer, int par3, int par4, int par5, int par6)
    {
        if (!par1World.isRemote && par2EntityPlayer.getCurrentEquippedItem() != null && par2EntityPlayer.getCurrentEquippedItem().itemID == Item.shears.shiftedIndex)
        {
            ...
            dropBlockAsItem_do(par1World, par3, par4, par5, new ItemStack(mod_Block.bush.blockID, 1, par6 & 3));
        }
        else
        {
