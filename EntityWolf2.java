...
public class EntityWolf2 extends EntityTameable
{
    ...
    {
        EntityWolf2 entitywolf2 = new EntityWolf2(worldObj);
        entitywolf2.setOwner(getOwnerName());
    ...
    public boolean canMateWith(EntityAnimal par1EntityAnimal)
    {
        ...
        if (!(par1EntityAnimal instanceof EntityWolf2))
        {
            return false;
        }

        EntityWolf2 entitywolf2 = (EntityWolf2)par1EntityAnimal;

        if (!entitywolf2.isTamed())
        {
            return false;
        }

        if (entitywolf2.isSitting())
        {
            return false;
        }
        else
        {
            return isInLove() && entitywolf2.isInLove();
        }
    }
}